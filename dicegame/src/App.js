  ...
  return (
    <div className={'App'}>
      ...
      <div className={'App-boards'}>
        <Board className={'App-board' + (total>otherTotal ? ' Board-winner': '')} text='나' color={'blue'} num={history[history.length - 1]} history={history} total={total}/>
        <Board className={'App-board' + (total<otherTotal ? ' Board-winner': '')} text='상대' color={'red'} num={otherHistory[history.length - 1]}
               history={otherHistory} total={otherTotal}/>
      </div>
    </div>
